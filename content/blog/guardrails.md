---
title: "The Guardrails Trapezoid"
...
I've been talking to quite a few smart tech leaders in fast growing startups and
...
Having good guardrails lets the coding agent roam freely without fear of damage.
Guardrails are one honking great idea -- let's have more of these!
...
It's where projects differ and tests come in many names:
System, Integration, Functional, Contract, Stress, etc.
...
It isn't there.
There are always some end-to-end tests at the top. 
Even in the worst case scenario, there are manual testing scripts run by QA engineers.

So it's trapezoid and it's bigger as it has guardrails.
...
Bugs are sneaky and for quality sake we need many types of tests.
A good trapezoid contains a few types of tests with overlapping coverage.

types of tests are need to verify 
Fowler emphasizes two main principles of the pyramid
